...
<section class="hero">
    <div class="container">
      ...
      <div class="hero-content pb-5 text-center">
        <h1 class="hero-heading"><?=$productFound->getName()?></h1>
        <div class="row">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1"><?= $typeNames[$productFound->getTypeId()-1]->getName() ?></p>
              <h3 class="h6 text-uppercase mb-1"><a href="product.html" class="text-dark"><?= $productFound->getName() ?></a></h3><span class="text-muted"><?= $productFound->getPrice() ?> €</span>
            </div>
          </div>
        </div>
