<section class="hero">
    <div class="container">
        ...
        <ol class="breadcrumb justify-content-center">
            <li class="breadcrumb-item"><a href="<?= $baseRoute ?>">Home</a></li>
            <li class="breadcrumb-item active"><?= $brands[$viewData['brandId'] - 1]->getName() ?></li>
        </ol>
        <!-- Hero Content-->
        <div class="hero-content pb-5 text-center">
            <h1 class="hero-heading"><?= $brands[$viewData['brandId'] - 1]->getName() ?></h1>
        </div>
    </div>
</section>
                ...
                <div class="product col-xl-3 col-lg-4 col-sm-6">
                    <div class="product-image">
                        <a href="<?= $router->generate('catalog-product', ['id' => $currentProduct->getId()]) ?>" class="product-hover-overlay-link">
                            <img src="<?= $baseRoute . "/" . $currentProduct->getPicture() ?>" alt="product" class="img-fluid">
                        </a>
                    </div>
                    ...
                    <div class="py-2">
                        <p class="text-muted text-sm mb-1">
                            <?= $types[$currentProduct->getType_id() - 1]->getName() ?>
                        </p>
                        <h3 class="h6 text-uppercase mb-1">
                            <a href="<?= $router->generate('catalog-product', ['id' => $currentProduct->getId()]) ?>" class="text-dark"><?= $currentProduct->getName() ?>
                            </a>
                        </h3>
                        <span class="text-muted"><?= $currentProduct->getPrice() ?> €</span>
                    </div>
                </div>
            <?php endforeach ?>
            <!-- /product-->
