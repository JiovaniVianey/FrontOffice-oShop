...
<section class="hero">
    <div class="container">
        ...
        <div class="hero-content pb-5 text-center">
            <h1 class="hero-heading">Marque: <?= $brandNames[$viewData['brandId'] - 1]->getName() ?></h1>
            <div class="row">
...
<section class="products-grid">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            // Affichage des produits selon leur type
            $productList = $productModel->findBrand($viewData['brandId']);
