<section>
  <div class="container-fluid">
    <div class="row mx-0">
      <div class="col-md-6">
        <div class="card border-0 text-white text-center"><img src="assets/images/categ5.jpeg" alt="Card image" class="card-img">
      ...
      <div class="col-md-6">
        <div class="card border-0 text-white text-center"><img src="assets/images/categ2.jpeg" alt="Card image" class="card-img">
          <div class="card-img-overlay d-flex align-items-center">
            <div class="w-100 py-3">
    ...
    <div class="row mx-0">
      ...
      <div class="col-lg-4">
        <div class="card border-0 text-center text-white"><img src="assets/images/categ4.jpeg" alt="Card image" class="card-img">
          <div class="card-img-overlay d-flex align-items-center">
            <div class="w-100">
      ...
      <div class="col-lg-4">
        <div class="card border-0 text-center text-white"><img src="assets/images/categ3.jpeg" alt="Card image" class="card-img">
          <div class="card-img-overlay d-flex align-items-center">
            <div class="w-100">
